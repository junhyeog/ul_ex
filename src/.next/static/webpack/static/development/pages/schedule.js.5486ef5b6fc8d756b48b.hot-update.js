...
})(["position:absolue;width:100vw;height:55px;background-image:linear-gradient(116deg,#ff7676,#fc6d7f 31%,#f75698 83%,#f54ea2 99%);.searchIcon{position:absolute;top:23px;right:20px;}"]);
...
})(["position:absolute;top:18px;left:55px;width:100px;height:24px;font-family:Verdana;font-size:20px;font-weight:normal;font-style:normal;font-stretch:normal;line-height:1.2;letter-spacing:normal;text-align:left;color:#ffffff;z-index:1;transform:translate(-50%,0);"]);

/***/ })

})
//# sourceMappingURL=schedule.js.5486ef5b6fc8d756b48b.hot-update.js.map
...
var HeaderEditImage = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].img.withConfig({
  displayName: "schedule__HeaderEditImage",
  componentId: "sc-7gsjoh-0"
})(["width:15px;height:15px;object-fit:contain;position:absolute;right:20px;top:14px;"]);
...
})(["position:relative;width:100vw;height:55px;background-image:linear-gradient(155deg,#ff7676,#fc6d7f 31%,#f75698 83%,#f54ea2 99%);text-align:center;.searchIcon{position:absolute;top:23px;right:20px;}"]);
...
})(["position:absolute;top:18px;width:30px;height:20px;font-family:Verdana;font-size:15px;font-weight:normal;font-style:normal;font-stretch:normal;line-height:1.2;letter-spacing:normal;text-align:left;color:#ffffff;left:55px;z-index:1;transform:translate(-50%,0);"]);

/***/ })

})
//# sourceMappingURL=schedule.js.b803c1695bf92c8ce14a.hot-update.js.map